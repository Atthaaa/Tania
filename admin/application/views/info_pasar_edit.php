  ...
  <form method="post" enctype="multipart/form-data">
    <div class="mb-3">
      ...
      <input type="text" name="judul_layanan_keuangan" id=""
        value="<?php echo set_value("artikel_layanan_keuangan", $info_pasar['judul_layanan_keuangan']) ?>" class="form-control">
    ...
    <div class="mb-3">
      ...
      <textarea name="artikel_layanan_keuangan" id="editorku"
        class="form-control"><?php echo set_value("artikel_layanan_keuangan", $info_pasar['artikel_layanan_keuangan']) ?></textarea>
      <span class="text-danger small">
    ...
    <div class="mb-3">
      ...
      <img src="<?php echo $this->config->item('url_layanan_keuangan') . $info_pasar['gambar_layanan_keuangan'] ?>" width="300">
    </div>
    <div class="mb-3">
