  ...
  <form method="post" enctype="multipart/form-data">
    <div class="mb-3">
      ...
      <input type="text" name="judul_layanan_keuangan" id=""
        value="<?php echo set_value("artikel_layanan_keuangan", $hama_penyakit['judul_layanan_keuangan']) ?>" class="form-control">
    ...
    <div class="mb-3">
      ...
      <textarea name="artikel_layanan_keuangan" id="editorku"
        class="form-control"><?php echo set_value("artikel_layanan_keuangan", $hama_penyakit['artikel_layanan_keuangan']) ?></textarea>
      <span class="text-danger small">
    ...
    <div class="mb-3">
      ...
      <img src="<?php echo $this->config->item('url_hama_penyakit') . $hama_penyakit['gambar_layanan_keuangan'] ?>" width="300">
    </div>
    <div class="mb-3">
