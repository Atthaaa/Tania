<div class="container">
  <h5>Produk Jual <?php $this->session->userdata('nama_member'); ?></h5>
    ...
    <tbody>
      <?php foreach ($produk as $key => $value) : ?>
        <tr>
          ...
          <td><?php echo number_format($value['berat_produk']) ?></td>
          <td>
            <img src="<?php echo $this->config->item('url_produk') . $value['foto_produk'] ?>" width="120" alt="">
          </td>
          <td>
