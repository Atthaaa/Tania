      ...
      <table class="table table-sm table-bordered">
        <?php foreach ($per_penjual['produk'] as $k => $per_produk) : ?>
          <tr>
            ...
            <td>
              <a href="<?= base_url('keranjang/hapus/' . $per_produk['id_keranjang']); ?>" class="btn btn-danger btn-sm">Hapus</a>
            </td>
          </tr>
        <?php endforeach ?>
      </table>
      <a href="<?php echo base_url("keranjang/checkout/" . $per_penjual["id_member"]) ?>" class="btn btn-primary">Checkout
      </a>
    </div>
  <?php endforeach ?>
</div>