<div class="container">
  <div class="row mb-5">
    ...
    <div class="col-md-3">
      ...
      <h6>Resi : <?= $transaksi['resi_ekspedisi']; ?></h6>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-6">
      <table class="table table-sm">
        <tr>
          <td>Total Tagihan</td>
          <td><?= $cekmidtrans->gross_amount; ?></td>
        </tr>
        <tr>
          <td>Tipe Pembayaran</td>
          <td>
            <?= $cekmidtrans->order_id; ?>
          </td>
        </tr>
        <tr>
          <td>Jenis Pembayaran</td>
          <td><?= $cekmidtrans->payment_type; ?></td>
        </tr>
        <?php if (isset($cekmidtrans->va_numbers)) : ?>
        <tr>
          <td>Nomor VA</td>
          <td><?= $cekmidtrans->va_numbers[0]->va_number; ?></td>
        </tr>
        <tr>
          <td>BANK</td>
          <td><?= $cekmidtrans->va_numbers[0]->bank; ?></td>
        </tr>
        <?php endif; ?>
        <tr>
          <td>Status Pembayaran</td>
          <td><?= $cekmidtrans->transaction_status; ?>
        ...
        <tr>
          ...
          <td><?= $cekmidtrans->transaction_time; ?></td>
        </tr>
        <tr>
          <td>Batas Akhir Pembayaran</td>
          <td><?= $cekmidtrans->expiry_time; ?></td>
        </tr>
      </table>
    </div>
  </div>
  ...
  <script src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="SB-Mid-client-PHG69u1KhRQDD1xT"></script>
...
<form method="post">
  <div class="container">
    ...
    <div class="mb-2">
      ...
      <p class="stars">
        <span k="<?= $k; ?>">
          <a k="<?= $k; ?>" class="star-1" href="#">1</a>
          <a k="<?= $k; ?>" class="star-2" href="#">2</a>
          <a k="<?= $k; ?>" class="star-3" href="#">3</a>
          <a k="<?= $k; ?>" class="star-4" href="#">4</a>
          <a k="<?= $k; ?>" class="star-5" href="#">5</a>
        </span>
      </p>
      <input type="hidden" class="jrt" name="jumlah_rating[]" id="" k="<?= $k; ?>">
      <input type="hidden" name="id_transaksi_detail[]" id="" value="<?= $v['id_transaksi_detail']; ?>">
