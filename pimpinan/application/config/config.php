...
|
*/
$config['base_url'] = 'http://localhost/TANIA/admin/';
$config['assets_kategori'] = $_SERVER['DOCUMENT_ROOT'] . '/TANIA/assets/kategori/';
$config['url_kategori'] = 'http://localhost/TANIA/assets/kategori/';
$config['assets_produk'] = $_SERVER['DOCUMENT_ROOT'] . '/TANIA/assets/produk/';
$config['url_produk'] = 'http://localhost/TANIA/assets/produk/';
